...
const benefits = [
  { icon: Zap, text: "Fast OTP delivery" },
  { icon: Globe2, text: "Worldwide virtual numbers" },
  { icon: ShieldCheck, text: "Protected wallet and orders" },
  { icon: Code2, text: "Developer-ready API" },
];
    ...
    <section className="relative isolate overflow-hidden border-b border-[var(--border)] bg-[var(--background)] py-16 sm:py-20 lg:py-28">
      ...
      <div className="site-container grid items-center gap-12 lg:grid-cols-[minmax(0,1.02fr)_minmax(420px,0.98fr)] lg:gap-16">
        <div className="animate-fade-up text-center lg:text-left">
          ...
          <div className="relative z-10 mt-8 flex flex-col justify-center gap-3 sm:flex-row sm:flex-wrap lg:justify-start">
        ...
        <div className="animate-fade-up animation-delay-150 relative mx-auto w-full max-w-xl lg:max-w-none">
          <div className="animate-float-soft pointer-events-none absolute -left-3 top-12 z-20 hidden rounded-2xl border border-[var(--border)] bg-[var(--card)] p-3 shadow-xl sm:block lg:-left-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-[var(--muted-foreground)]">Order status</p>
                <p className="text-sm font-black text-[var(--foreground)]">OTP received</p>
              </div>
            </div>
          </div>
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-4">
                  ...
                  <div className="mt-3 flex items-center justify-between gap-3">
                    ...
                    <span
                      aria-hidden="true"
                      className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[var(--muted)] text-[var(--muted-foreground)]"
                    >
                      <Copy size={16} />
                    </span>
                  </div>
                ...
                <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-black text-[var(--foreground)]">₦9,419.00</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-black text-[var(--foreground)]">Real-time updates</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="animate-float-soft animation-delay-300 pointer-events-none absolute -bottom-6 right-3 z-20 hidden rounded-2xl border border-[var(--border)] bg-[var(--card)] p-3 shadow-xl sm:block lg:-right-7">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-[var(--muted-foreground)]">Built for developers</p>
                <p className="text-sm font-black text-[var(--foreground)]">REST API ready</p>
              </div>
            </div>
          </div>
        </div>
