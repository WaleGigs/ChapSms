...
const primaryLink =
  "focus-ring relative z-30 inline-flex min-h-13 w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3.5 text-base font-semibold text-white shadow-sm shadow-blue-600/20 transition duration-200 hover:bg-blue-700 active:scale-[0.98] sm:w-auto sm:px-7";

const secondaryLink =
  "focus-ring relative z-30 inline-flex min-h-13 w-full items-center justify-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--card)] px-6 py-3.5 text-base font-semibold text-[var(--foreground)] shadow-sm transition duration-200 hover:border-blue-300 hover:bg-[var(--muted)] active:scale-[0.98] dark:hover:border-blue-800 sm:w-auto sm:px-7";
